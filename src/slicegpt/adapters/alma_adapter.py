...
class CompressedAlmaDecoderLayer(LlamaDecoderLayer):
    """
    This class simulates the LlamaDecoderLayer class from transformers
    but with the addition of a shortcut_Q attribute for ALMA model.
    """
...
class AlmaLayerAdapter(LayerAdapter):
...
class AlmaModelAdapter(ModelAdapter):
    ...
    def layer_adapter_type(self) -> type:
        return AlmaLayerAdapter

    @property
    def compressed_layer_type(self) -> type:
        return CompressedAlmaDecoderLayer
    ...
    def _from_pretrained(
        ...
        *,
        ...
        if not model_name.startswith("haoranxu/ALMA-7B"):
            return None
    ...
    def _from_uninitialized(
        ...
        *,
        ...
        class UninitializedAlmaForCausalLM(LlamaForCausalLM):
        ...
        model = UninitializedAlmaForCausalLM(config)
